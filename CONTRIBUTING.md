...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Predictive-Analytics.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Predictive-Analytics.cd

# Install dependencies
go mod download

# Build
go build -o predictiveanalytics .
